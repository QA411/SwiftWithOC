...
- (NSString*)jk_stringByPercentageEncodingWithReservedCharacters {
...
- (NSString*)jk_URLQueryStringWithSortedKeys:(BOOL)sortedKeys {
    ...
    return queryString.length ? [queryString jk_stringByPercentageEncodingWithReservedCharacters] : nil;
}
